...
_setupObjects =
{
	...
	_missionHintText = format ["A treasure containing <t color='%1'>$30,000</t> and weapons is being recovered.<br/>You will need diving gear and an underwater weapon to complete the mission.", moneyMissionColor];
};
