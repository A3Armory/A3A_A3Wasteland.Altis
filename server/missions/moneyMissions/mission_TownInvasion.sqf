...
private ["_nbUnits", "_box1", "_box2", "_townName", "_missionPos", "_cashbox1", "_cashbox2", "_buildingRadius", "_putOnRoof", "_fillEvenly", "_tent1", "_chair1", "_chair2", "_cFire1"];
...
_setupObjects =
{
	...
	_cashbox1 = floor(random 25000);
	_cashbox2 = floor(random 25000);
	...
	_box2 = createVehicle ["Box_East_Wps_F", _missionPos, [], 2, "None"];
