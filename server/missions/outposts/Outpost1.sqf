...
[
	...
	["Box_IND_WpsSpecial_F", [-6.24817, 8.69141, 0], 180, { [_this, ["mission_USLaunchers","mission_Main_A3snipers","mission_Uniform","mission_DLCLMGs","mission_ApexRifles"] call BIS_fnc_selectRandom] call fn_refillbox }],
	...
	["Box_East_WpsSpecial_F", [6.26294, -10.02422, 0], 180, { [_this, ["mission_USSpecial","mission_HVSniper","mission_DLCRifles","mission_HVLaunchers"] call BIS_fnc_selectRandom] call fn_refillbox }],
