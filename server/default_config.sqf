...
A3W_bountyMax = 700000;            // Maximum amount of money that can be set as a bounty on someone
...
A3W_privateParkingCost = 6500;     // Cost to retrieve an individual vehicle from private parking
...
A3W_extDB_Environment = "a3w";     // Value used to separate player & object data from multiple environments running on the same map (e.g. "normal", "hardcore", "dev", etc. can be whatever you want)
