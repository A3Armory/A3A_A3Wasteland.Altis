...
[
	...
	["Static Titan AT 4Rnd", "B_static_AT_F", 5750], // Static launchers only have 4 ammo, hence the low price
	["Static Titan AT 4Rnd", "O_static_AT_F", 5750],
	["Static Titan AT 4Rnd", "I_static_AT_F", 5750],
...
[
	...
	["MQ-12 Falcon UAV", "B_T_UAV_03_F", 80000, "vehicle"] // Do NOT use "B_T_UAV_03_dynamicLoadout_F" (doesn't support ASRAAM pylons)
];

planesArray = compileFinal str
[
	["Caesar BTT", "C_Plane_Civil_01_F", 6500, "vehicle"],
	...
	["MQ4A Greyhawk Missile UAV", "B_UAV_02_dynamicLoadout_F", 70000, "vehicle", "variant_greyhawkMissile"],
	["K40 Ababil-3 Missile UAV", "O_UAV_02_dynamicLoadout_F", 70000, "vehicle", "variant_greyhawkMissile"],
	["K40 Ababil-3 Missile UAV", "I_UAV_02_dynamicLoadout_F", 70000, "vehicle", "variant_greyhawkMissile"],
	...
	["KH-3A Fenghuang Missile UAV", "O_T_UAV_04_CAS_F", 70000, "vehicle"],
