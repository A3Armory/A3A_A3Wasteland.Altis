...
pp_retrieve_cost = ["A3W_privateParkingCost", 3500] call getPublicVar;

//maximum number of vehicles that a player can park (0 = no limit)
pp_max_player_vehicles = ["A3W_privateParkingLimit", 4] call getPublicVar;

//List of class names for vehicles that are not allowed to be parked
pp_disallowed_vehicle_classes = ["StaticWeapon", "UAV_01_base_F"];
