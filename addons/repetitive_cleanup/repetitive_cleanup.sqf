...
private _ttdBodies = M* 0; // seconds to delete dead bodies (0 means don't delete)
private _ttdVehiclesDead = M* 0; // seconds to delete dead vehicles (0 means don't delete)
private _ttdVehiclesImmobile = M* 0; // seconds to delete immobile vehicles (0 means don't delete)
